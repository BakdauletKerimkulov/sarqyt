...
- [x] `lib/src/features/notifications/application/push_deep_link.dart` — чистая функция маппинга + `@Riverpod(keepAlive: true)` pending-deep-link провайдер. Без импортов Firebase

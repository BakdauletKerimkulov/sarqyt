...
@JsonKey(fromJson: _readRequiredId) ItemID get id;@JsonKey(fromJson: _readRequiredName) String get name;@JsonKey(fromJson: _readRequiredPrice, toJson: _writePrice) double get price;@JsonKey(fromJson: _readRequiredSchedule, toJson: _writeSchedule) WeeklySchedule get schedule;@JsonKey(readValue: _readEstimatedValueSource, fromJson: _readOptionalPrice, toJson: _writeOptionalPrice) double? get estimatedValue; String? get imageUrl; String? get description; String? get category;@JsonKey(unknownEnumValue: DietaryType.notSpecified) DietaryType get dietaryType;@JsonKey(unknownEnumValue: PackagingOption.withBagOrOwnBag) PackagingOption get packagingType; String? get collectionInstructions; bool get isActive;@JsonKey(unknownEnumValue: ItemType.scheduled) ItemType get type; String? get oneTimeDate; int? get oneTimeStartHour; int? get oneTimeStartMinute; int? get oneTimeEndHour; int? get oneTimeEndMinute; int? get oneTimeQuantity; bool get isBuffetFood; String? get storingAndAllergens; List<Badge> get badges; Rating? get averageOverallRating;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Item&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.schedule, schedule) || other.schedule == schedule)&&(identical(other.estimatedValue, estimatedValue) || other.estimatedValue == estimatedValue)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.description, description) || other.description == description)&&(identical(other.category, category) || other.category == category)&&(identical(other.dietaryType, dietaryType) || other.dietaryType == dietaryType)&&(identical(other.packagingType, packagingType) || other.packagingType == packagingType)&&(identical(other.collectionInstructions, collectionInstructions) || other.collectionInstructions == collectionInstructions)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.type, type) || other.type == type)&&(identical(other.oneTimeDate, oneTimeDate) || other.oneTimeDate == oneTimeDate)&&(identical(other.oneTimeStartHour, oneTimeStartHour) || other.oneTimeStartHour == oneTimeStartHour)&&(identical(other.oneTimeStartMinute, oneTimeStartMinute) || other.oneTimeStartMinute == oneTimeStartMinute)&&(identical(other.oneTimeEndHour, oneTimeEndHour) || other.oneTimeEndHour == oneTimeEndHour)&&(identical(other.oneTimeEndMinute, oneTimeEndMinute) || other.oneTimeEndMinute == oneTimeEndMinute)&&(identical(other.oneTimeQuantity, oneTimeQuantity) || other.oneTimeQuantity == oneTimeQuantity)&&(identical(other.isBuffetFood, isBuffetFood) || other.isBuffetFood == isBuffetFood)&&(identical(other.storingAndAllergens, storingAndAllergens) || other.storingAndAllergens == storingAndAllergens)&&const DeepCollectionEquality().equals(other.badges, badges)&&(identical(other.averageOverallRating, averageOverallRating) || other.averageOverallRating == averageOverallRating));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,price,schedule,estimatedValue,imageUrl,description,category,dietaryType,packagingType,collectionInstructions,isActive,type,oneTimeDate,oneTimeStartHour,oneTimeStartMinute,oneTimeEndHour,oneTimeEndMinute,oneTimeQuantity,isBuffetFood,storingAndAllergens,const DeepCollectionEquality().hash(badges),averageOverallRating]);

@override
String toString() {
  return 'Item(id: $id, name: $name, price: $price, schedule: $schedule, estimatedValue: $estimatedValue, imageUrl: $imageUrl, description: $description, category: $category, dietaryType: $dietaryType, packagingType: $packagingType, collectionInstructions: $collectionInstructions, isActive: $isActive, type: $type, oneTimeDate: $oneTimeDate, oneTimeStartHour: $oneTimeStartHour, oneTimeStartMinute: $oneTimeStartMinute, oneTimeEndHour: $oneTimeEndHour, oneTimeEndMinute: $oneTimeEndMinute, oneTimeQuantity: $oneTimeQuantity, isBuffetFood: $isBuffetFood, storingAndAllergens: $storingAndAllergens, badges: $badges, averageOverallRating: $averageOverallRating)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _readRequiredId) ItemID id,@JsonKey(fromJson: _readRequiredName) String name,@JsonKey(fromJson: _readRequiredPrice, toJson: _writePrice) double price,@JsonKey(fromJson: _readRequiredSchedule, toJson: _writeSchedule) WeeklySchedule schedule,@JsonKey(readValue: _readEstimatedValueSource, fromJson: _readOptionalPrice, toJson: _writeOptionalPrice) double? estimatedValue, String? imageUrl, String? description, String? category,@JsonKey(unknownEnumValue: DietaryType.notSpecified) DietaryType dietaryType,@JsonKey(unknownEnumValue: PackagingOption.withBagOrOwnBag) PackagingOption packagingType, String? collectionInstructions, bool isActive,@JsonKey(unknownEnumValue: ItemType.scheduled) ItemType type, String? oneTimeDate, int? oneTimeStartHour, int? oneTimeStartMinute, int? oneTimeEndHour, int? oneTimeEndMinute, int? oneTimeQuantity, bool isBuffetFood, String? storingAndAllergens, List<Badge> badges, Rating? averageOverallRating
});
...
/// Create a copy of Item
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? price = null,Object? schedule = null,Object? estimatedValue = freezed,Object? imageUrl = freezed,Object? description = freezed,Object? category = freezed,Object? dietaryType = null,Object? packagingType = null,Object? collectionInstructions = freezed,Object? isActive = null,Object? type = null,Object? oneTimeDate = freezed,Object? oneTimeStartHour = freezed,Object? oneTimeStartMinute = freezed,Object? oneTimeEndHour = freezed,Object? oneTimeEndMinute = freezed,Object? oneTimeQuantity = freezed,Object? isBuffetFood = null,Object? storingAndAllergens = freezed,Object? badges = null,Object? averageOverallRating = freezed,}) {
...
as ItemType,oneTimeDate: freezed == oneTimeDate ? _self.oneTimeDate : oneTimeDate // ignore: cast_nullable_to_non_nullable
as String?,oneTimeStartHour: freezed == oneTimeStartHour ? _self.oneTimeStartHour : oneTimeStartHour // ignore: cast_nullable_to_non_nullable
as int?,oneTimeStartMinute: freezed == oneTimeStartMinute ? _self.oneTimeStartMinute : oneTimeStartMinute // ignore: cast_nullable_to_non_nullable
as int?,oneTimeEndHour: freezed == oneTimeEndHour ? _self.oneTimeEndHour : oneTimeEndHour // ignore: cast_nullable_to_non_nullable
as int?,oneTimeEndMinute: freezed == oneTimeEndMinute ? _self.oneTimeEndMinute : oneTimeEndMinute // ignore: cast_nullable_to_non_nullable
as int?,oneTimeQuantity: freezed == oneTimeQuantity ? _self.oneTimeQuantity : oneTimeQuantity // ignore: cast_nullable_to_non_nullable
as int?,isBuffetFood: null == isBuffetFood ? _self.isBuffetFood : isBuffetFood // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Item() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.schedule,_that.estimatedValue,_that.imageUrl,_that.description,_that.category,_that.dietaryType,_that.packagingType,_that.collectionInstructions,_that.isActive,_that.type,_that.oneTimeDate,_that.oneTimeStartHour,_that.oneTimeStartMinute,_that.oneTimeEndHour,_that.oneTimeEndMinute,_that.oneTimeQuantity,_that.isBuffetFood,_that.storingAndAllergens,_that.badges,_that.averageOverallRating);case _:
  return orElse();
...
class _Item extends Item {
  const _Item({@JsonKey(fromJson: _readRequiredId) required this.id, @JsonKey(fromJson: _readRequiredName) required this.name, @JsonKey(fromJson: _readRequiredPrice, toJson: _writePrice) required this.price, @JsonKey(fromJson: _readRequiredSchedule, toJson: _writeSchedule) required this.schedule, @JsonKey(readValue: _readEstimatedValueSource, fromJson: _readOptionalPrice, toJson: _writeOptionalPrice) this.estimatedValue, this.imageUrl, this.description, this.category, @JsonKey(unknownEnumValue: DietaryType.notSpecified) this.dietaryType = DietaryType.notSpecified, @JsonKey(unknownEnumValue: PackagingOption.withBagOrOwnBag) this.packagingType = PackagingOption.withBagOrOwnBag, this.collectionInstructions, this.isActive = false, @JsonKey(unknownEnumValue: ItemType.scheduled) this.type = ItemType.scheduled, this.oneTimeDate, this.oneTimeStartHour, this.oneTimeStartMinute, this.oneTimeEndHour, this.oneTimeEndMinute, this.oneTimeQuantity, this.isBuffetFood = false, this.storingAndAllergens, final  List<Badge> badges = const [], this.averageOverallRating}): _badges = badges,super._();
...
@override@JsonKey(unknownEnumValue: ItemType.scheduled) final  ItemType type;
@override final  String? oneTimeDate;
@override final  int? oneTimeStartHour;
@override final  int? oneTimeStartMinute;
@override final  int? oneTimeEndHour;
@override final  int? oneTimeEndMinute;
@override final  int? oneTimeQuantity;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,price,schedule,estimatedValue,imageUrl,description,category,dietaryType,packagingType,collectionInstructions,isActive,type,oneTimeDate,oneTimeStartHour,oneTimeStartMinute,oneTimeEndHour,oneTimeEndMinute,oneTimeQuantity,isBuffetFood,storingAndAllergens,const DeepCollectionEquality().hash(_badges),averageOverallRating]);

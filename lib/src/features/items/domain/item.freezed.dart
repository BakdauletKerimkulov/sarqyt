...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,price,schedule,estimatedValue,imageUrl,description,category,dietaryType,packagingType,collectionInstructions,isBuffetFood,storingAndAllergens,const DeepCollectionEquality().hash(badges),averageOverallRating);

@override
String toString() {
  return 'Item(id: $id, name: $name, price: $price, schedule: $schedule, estimatedValue: $estimatedValue, imageUrl: $imageUrl, description: $description, category: $category, dietaryType: $dietaryType, packagingType: $packagingType, collectionInstructions: $collectionInstructions, isBuffetFood: $isBuffetFood, storingAndAllergens: $storingAndAllergens, badges: $badges, averageOverallRating: $averageOverallRating)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _readRequiredId) ItemID id,@JsonKey(fromJson: _readRequiredName) String name,@JsonKey(fromJson: _readRequiredPrice, toJson: _writePrice) double price,@JsonKey(fromJson: _readRequiredSchedule, toJson: _writeSchedule) WeeklySchedule schedule,@JsonKey(readValue: _readEstimatedValueSource, fromJson: _readOptionalPrice, toJson: _writeOptionalPrice) double? estimatedValue, String? imageUrl, String? description, String? category,@JsonKey(unknownEnumValue: DietaryType.notSpecified) DietaryType dietaryType,@JsonKey(unknownEnumValue: PackagingOption.withBagOrOwnBag) PackagingOption packagingType, String? collectionInstructions, bool isBuffetFood, String? storingAndAllergens, List<Badge> badges, Rating? averageOverallRating
});
...
as String?,isBuffetFood: null == isBuffetFood ? _self.isBuffetFood : isBuffetFood // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Item() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.schedule,_that.estimatedValue,_that.imageUrl,_that.description,_that.category,_that.dietaryType,_that.packagingType,_that.collectionInstructions,_that.isBuffetFood,_that.storingAndAllergens,_that.badges,_that.averageOverallRating);case _:
  return orElse();
...
class _Item extends Item {
  const _Item({@JsonKey(fromJson: _readRequiredId) required this.id, @JsonKey(fromJson: _readRequiredName) required this.name, @JsonKey(fromJson: _readRequiredPrice, toJson: _writePrice) required this.price, @JsonKey(fromJson: _readRequiredSchedule, toJson: _writeSchedule) required this.schedule, @JsonKey(readValue: _readEstimatedValueSource, fromJson: _readOptionalPrice, toJson: _writeOptionalPrice) this.estimatedValue, this.imageUrl, this.description, this.category, @JsonKey(unknownEnumValue: DietaryType.notSpecified) this.dietaryType = DietaryType.notSpecified, @JsonKey(unknownEnumValue: PackagingOption.withBagOrOwnBag) this.packagingType = PackagingOption.withBagOrOwnBag, this.collectionInstructions, this.isBuffetFood = false, this.storingAndAllergens, final  List<Badge> badges = const [], this.averageOverallRating}): _badges = badges,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,price,schedule,estimatedValue,imageUrl,description,category,dietaryType,packagingType,collectionInstructions,isBuffetFood,storingAndAllergens,const DeepCollectionEquality().hash(_badges),averageOverallRating);

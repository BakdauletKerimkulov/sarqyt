...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,itemId,storeId,customerId,itemName,storeName,itemImageUrl,unitPrice,currencyCode,currencySymbol,itemQuantity,status,paymentStatus,pickupStartTime,pickupEndTime,createdAt,updatedAt,orderNumber,offerId,paymentIntentId]);

@override
String toString() {
  return 'Order(id: $id, itemId: $itemId, storeId: $storeId, customerId: $customerId, itemName: $itemName, storeName: $storeName, itemImageUrl: $itemImageUrl, unitPrice: $unitPrice, currencyCode: $currencyCode, currencySymbol: $currencySymbol, itemQuantity: $itemQuantity, status: $status, paymentStatus: $paymentStatus, pickupStartTime: $pickupStartTime, pickupEndTime: $pickupEndTime, createdAt: $createdAt, updatedAt: $updatedAt, orderNumber: $orderNumber, offerId: $offerId, paymentIntentId: $paymentIntentId)';
}
